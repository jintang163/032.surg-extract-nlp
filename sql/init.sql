...
CREATE TABLE `surgery_record` (
    ...
    `process_status`      VARCHAR(32)     NOT NULL DEFAULT 'PENDING' COMMENT '处理状态: PENDING-待处理, OCR_PROCESSING-OCR处理中, OCR_DONE-OCR完成, NER_PROCESSING-实体抽取中, NER_DONE-抽取完成, COMPLETED-已完成, FAILED-失败',
